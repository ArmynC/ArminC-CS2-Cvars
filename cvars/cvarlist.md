...
cl_viewmodel_reprediction_override | cl | Default: 0<br>Disable reprediction for CS2 viewmodels. 0 = Leave it as-is, 1 = allow prediction errors, 2 = ignore prediction errors, 3 = ignore prediction errors and copy corrections forward
...
composite_material_use_bc7 | cl | Default: false<br>
...
crowbar_impact_damage_mass | sv | Default: 8<br>
...
csgo_econ_action_preview | cl, norecord, clientcmd_can_execute | Preview an economy item
...
csgo_mappreview_transparent_background_col_performance | cl | Default: 0.3<br>
...
ent_steadystate_enable | sv | Default: true<br>
...
error_message_explain_pure | cl, clientcmd_can_execute | Take user to Steam support article
error_message_explain_unsigned | cl, clientcmd_can_execute | Take user to Steam support article
error_message_explain_vac | cl, clientcmd_can_execute | Take user to Steam support article
...
fire_absorbrate | sv | Default: 3<br>
fire_dmgbase | sv | Default: 1<br>
fire_dmginterval | sv | Default: 1<br>
fire_dmgscale | sv | Default: 0.1<br>
fire_extabsorb | sv | Default: 5<br>
fire_extinguishes_under_water | sv, cl, rep | Default: false<br>
fire_extscale | sv | Default: 12<br>
fire_growthrate | sv | Default: 1<br>
fire_heatscale | sv | Default: 1<br>
fire_incomingheatscale | sv | Default: 0.1<br>
fire_maxabsorb | sv | Default: 50<br>
...
fs_fake_read_delay_ms |  | Default: 0<br>Add N ms of delay to every low-level read operation, to simulate a slow disk
...
hullivr_edge_merge_tan | rep | Default: 0.02<br>Should we try to straighten two faces connected to this edge? (tangent)
hullivr_faceisland_merge_disp | rep | Default: 0<br>Should we straighten face island if the displacement is this much? (inches)
hullivr_faceisland_merge_tan | rep | Default: 0.04<br>Should we try to straighten an island of faces deviating from their average normal (tangent)?
hullivr_version | rep | Default: 3<br>
hurtme | sv, cheat | Hurts the player.<br>	Arguments: &lt;health to lose&gt;
ic | cl | interp entity count<br>
ik_constraints_enabled |  | Default: true<br>
ik_debug_all_chains_unique_color_per_chain |  | Default: false<br>
ik_debug_ccd |  | Default: 0<br>
ik_debug_chain_to_filter_by | sv, cl, rep, cheat | Default: <br>
ik_debug_constraints |  | Default: -1<br>
ik_debug_dogleg3bone |  | Default: 0<br>
ik_debug_dogleg3bone_enabled |  | Default: true<br>
ik_debug_fabrik_backwards_enabled |  | Default: true<br>
ik_debug_fabrik_backwards_iteration_toggle |  | 
ik_debug_fabrik_backwards_iterations |  | Default: 0<br>
ik_debug_fabrik_forwards_enabled |  | Default: true<br>
ik_debug_fabrik_forwards_iteration_toggle |  | 
ik_debug_fabrik_forwards_iterations |  | Default: 0<br>
...
ik_debug_planetilt |  | Default: 0<br>
ik_debug_planetilt_axis_length |  | Default: 20<br>
ik_debug_targets |  | Default: false<br>
ik_enable | cheat | Default: true<br>Enable IK.
ik_fabrik_align_chain |  | Default: true<br>
ik_fabrik_backwards_enabled |  | Default: true<br>
ik_fabrik_forwards_enabled |  | Default: true<br>
ik_fabrik_override_num_iterations |  | Default: -1<br>
ik_final_fixup_enable |  | Default: true<br>
ik_hinge_debug_bone_index | sv, cl, rep, cheat | Default: -1<br>
ik_planetilt_enable |  | Default: true<br>
...
imgui_show_example_window | sv, cl, a, rep, cheat | Default: false<br>Source2/Show Example Window
imgui_show_grenades_window | sv, cl, a, rep, cheat | Default: false<br>CS2/Show Grenades History
imgui_show_overlay_nav_editor | sv, cheat | Default: false<br>Game/Nav Editor
imgui_show_sim_history_window | sv, cl, a, rep, cheat | Default: false<br>Simulation History
imgui_show_sound_window | sv, cl, a, rep, cheat | Default: false<br>Source2/Show Sound Window
...
keychain_reactivity | cl | Default: 0.1<br>
keychain_wmul | cl | Default: 1<br>
...
matchdraft_debug_sendlog | cl, norecord, release, clientcmd_can_execute | Print debug draft into HTTP log
...
mm_queue_draft_show | cl, clientcmd_can_execute | Display current draft
...
mp_damage_headshot_only | sv, rep, release | Default: false<br>Determines whether non-headshot hits do any damage.
mp_damage_scale_ct_body | sv, rep, release | Default: 1<br>Scales the damage a CT player takes by this much when they take damage in the body. (1 == 100%, 0.5 == 50%)
mp_damage_scale_ct_head | sv, rep, release | Default: 1<br>Scales the damage a CT player takes by this much when they take damage in the head (1 == 100%, 0.5 == 50%).  REMEMBER! headshots do 4x the damage of the body before this scaler is applied.
mp_damage_scale_t_body | sv, rep, release | Default: 1<br>Scales the damage a T player takes by this much when they take damage in the body. (1 == 100%, 0.5 == 50%)
mp_damage_scale_t_head | sv, rep, release | Default: 1<br>Scales the damage a T player takes by this much when they take damage in the head (1 == 100%, 0.5 == 50%).	 REMEMBER! headshots do 4x the damage of the body before this scaler is applied.
...
mp_flinch_punch_scale | sv, rep, cheat | Default: 3<br>Scalar for first person view punch when getting hit.
...
mp_heavyassaultsuit_aimpunch | sv, cl, rep, release | Default: true<br>How much EXTRA aim punch will happen when a player wearing the assault suit gets when shot
mp_heavyassaultsuit_cooldown | sv, cl, rep, release | Default: 5<br>Determines cooldown of purchase.
mp_heavyassaultsuit_deploy_timescale | sv, cl, rep, release | Default: 0.8<br>How fast a player wearing the heavy assault suit will draw their weapon (1.0 = normal speed, 0.5 = half speed)
mp_heavyassaultsuit_speed | sv, cl, rep, release | Default: 130<br>The max speed of a player when they are wearing the heavy assault suit
mp_heavybot_damage_reduction_scale | sv, cl, rep, release | Default: 1<br>How much damage should scale when the player wearing the heavy assault suit is shot (1.0 = no change, 0.5 = half damage)
...
mp_weapons_allow_heavyassaultsuit | sv, cl, rep, release | Default: false<br>Determines whether heavyassaultsuit is permitted.
...
nav_draw_space_scatter | sv, cheat | Default: false<br>
...
nav_gen_oriented_angle_tol | cheat | Default: 15<br>Max abrupt orientation difference an NPC can tolerate when moving through the mesh (degrees).
nav_gen_oriented_max_region_range | cheat | Default: 30<br>Max orientation range allowed within a region before it gets further split.
...
panorama_cache_command_list_size_threshold |  | Default: 2048<br>
...
panorama_force_text_shadow_strength |  | Default: -1<br>
...
phys2_contact_debug_draw_size |  | Default: 2<br>
phys2_debug_broadphase |  | Default: 0<br>
phys_active | sv | Default: true<br>Whether PLAYER physics is actively simulated (ie. noclip)
phys_async_buoyancy_update | sv, cl, rep | Default: false<br>If true, buoyancy motion controllers are updated in an async job after the tick has completed.
phys_batch_ray_test | cl | Default: 0<br>
phys_build_bounds |  | Default: false<br>
phys_build_mass |  | Default: false<br>
phys_buoyancy_angular_damping_multiplier | nf, rep | Default: 1<br>Multiply water damping for buoyancy affecting angular velocity
phys_buoyancy_drag_multiplier | nf, rep | Default: 1<br>Multiply water drag (tries to equalize object velocity with the velocity of the water flow)
...
phys_deterministic | rep | Default: true<br>
phys_drag_multiplier | nf, rep | Default: 1<br>Multiply air drag
phys_dump_filter_body_name |  | Default: <br>
phys_dump_filter_solid_only |  | Default: false<br>
phys_dump_filter_trace_callstack |  | Default: <br>
...
phys_enable_fallback_toi | rep | Default: true<br>
phys_enable_gjk_clipping | rep | Default: false<br>
...
phys_headshotscale | sv, rep | Default: 1.3<br>Modifier for the headshot impulse hits on players
...
phys_implicit_integarator | nf, rep | Default: true<br>Use implicit integrator for gyroscopic forces
phys_intermediate_notify_remove_only | rep | Default: true<br>
phys_jiggle_bone_enable |  | Default: true<br>
phys_joint_elasticity_max_rest |  | Default: 0.25<br>
phys_joint_elasticity_min_rest |  | Default: 0.01<br>
phys_joint_plasticity_threshold_max |  | Default: 0.1<br>
phys_joint_plasticity_threshold_min |  | Default: 0.01<br>
...
phys_skip_creating_trivial_islands | rep | Default: false<br>
...
phys_validate |  | Default: false<br>
phys_vehicleimpactforcescale | sv | Default: 1.5<br>
phys_velocity_iterations |  | Default: 8<br>
...
physcannon_maxforce | sv | Default: 1500<br>
physcannon_minforce | sv | Default: 700<br>
...
physics_hull_sphere_cast_sat_experimental |  | Default: 1<br>
...
player_competitive_maplist_8_10_0_CAE97738 | cl, a | Default: mg_de_thera,mg_de_dust2,mg_de_ancient,mg_de_inferno,mg_de_nuke,mg_de_vertigo,mg_de_mirage,mg_cs_office,mg_cs_italy,mg_de_mills,mg_de_anubis,mg_lobby_mapveto,mg_de_overpass<br>
...
prop_nav_obstacle_block_edge_min_b | sv | Default: -1<br>
...
props_breakable_debug_spawn | sv, cl, rep | Default: false<br>
...
r_csgo_gpu_culling_camera_offset | cl | Default: -0.5<br>
...
r_csgo_lowend_objects | cl | Default: true<br>0 = Force disable, 1 = use video settings
...
r_csgo_water_reflections | cl | Default: true<br>
...
r_decals_default_fade_duration | cl, rep | Default: 1<br>
r_decals_default_start_fade | cl, rep | Default: 30<br>
r_decals_overide_fadestarttime_params | sv, cl, rep | Default: -1<br>
r_decals_overlap_threshold | cl, rep | Default: 6<br>
r_depth_of_field | cl | Default: 1<br>0 = off, 1 = enabled (high quality, circular bokeh, HDR)
r_detail_lerp_znormal | cl | Default: 0.89<br>
r_detailprop_fade_dist | cl | Default: 3000<br>
r_detailprop_force_probe | cl | Default: false<br>
r_detailprop_lod_dist | cl | Default: 4000<br>
...
r_drawdetailprops | cl | Default: true<br>
r_drawdevvisualizers | cl, cheat | Default: false<br>Render dev visualizers
r_drawmodeldecals | cl | Default: true<br>
...
r_grass_parallel_load |  | Default: false<br>
...
restart_in_insecure | cl, clientcmd_can_execute | Restart in insecure mode
restart_in_trusted | cl, clientcmd_can_execute | Restart in trusted mode
restart_in_untrusted | cl, clientcmd_can_execute | Restart in untrusted mode
restart_normal | cl, clientcmd_can_execute | Restart
...
sc_aggregate_debug_draw_meshlets |  | Default: false<br>SceneSystem/Aggregates/Visualize Meshlets
...
sc_barnlight_enable_precomputed_vis |  | Default: false<br>Enable use of precomputed vis membership for lights (requires map restart)
...
sc_clutter_density_full_size |  | Default: 0.05<br>Screen-size where clutter will be full density
sc_clutter_density_none_size |  | Default: 0.01<br>Screen-size where clutter will be gone
sc_clutter_draw |  | Default: true<br>SceneSystem/Aggregates/Draw Aggregates
...
sc_show_tonemap_visualizer | cheat | Default: false<br>SceneSystem/Tonemap Visualizer
...
show_untrusted_warning_again | cl, clientcmd_can_execute | Show untrusted warning again
...
smooth_cloth_amax |  | Default: 0.5<br>
smooth_cloth_amin |  | Default: 0.01<br>
smooth_cloth_amul |  | Default: 0.4<br>
...
snd_sos_compare_kv3_native_stacks | cheat | Default: false<br>
...
snd_sos_default_update_stack |  | Default: core_update_default<br>
...
snd_sos_use_case_sensitive_soundevents |  | Default: false<br>
...
snd_steamaudio_max_probes_customdata |  | Default: 4294967295<br>Maximum number of probes to create when baking custom data.
...
sparseshadowtree_copy_to_shadow_atlas_ps | cl | Default: true<br>Copy layer from CS output to shadow atlas uses PS copy (vs CopyTexture).
sparseshadowtree_cs_debug_colors | cl | Default: false<br>Output debug colors for SST CS.
sparseshadowtree_cs_exclude_next_cascade_region | cl | Default: true<br>Exclude the inner region of a cascade during CS unpack if there is a higher resolution cascade that will cover that area.
sparseshadowtree_cs_unpack_mode | cl | Default: 1<br>Unpack mode in cs, 0 - one leaf per thread (16 output pixels), 1 (default) - one leaf row per thread (4 output pixels), 2 - one pixel out per thread.
sparseshadowtree_debug_tile_range_xmax | cl | Default: 72<br>SST Tile range for renderdoc/debug capturing.
sparseshadowtree_debug_tile_range_xmin | cl | Default: 71<br>SST Tile range for renderdoc/debug capturing.
sparseshadowtree_debug_tile_range_ymax | cl | Default: 81<br>SST Tile range for renderdoc/debug capturing.
sparseshadowtree_debug_tile_range_ymin | cl | Default: 80<br>SST Tile range for renderdoc/debug capturing.
sparseshadowtree_disable_for_viewmodel | cl | Default: false<br>Disable SST generation and runtime for viewmodel (use original CSM rendering).
sparseshadowtree_enable_rendering | cl | Default: true<br>Enable use of SST at runtime (static geo rendered into cascades via SST).
sparseshadowtree_leaf_compress_scaleoffset | cl | Default: true<br>Compress leaf node depths using scale & offset.
sparseshadowtree_leaf_precision | cl | Default: 4e-06<br>precision for depth compression at SST leaf nodes.
sparseshadowtree_leaf_precision_viewmodel | cl | Default: 0.0005<br>(viewmodel) precision for depth compression at SST leaf nodes.
sparseshadowtree_parallel_generation | cl | Default: 2<br>Split SST tile generation into threadjobs (0 - disabled, 1 - wait on readpixels for job batch, 2 - async readpixels).
sparseshadowtree_plane_incr_per_step | cl | Default: 1e-05<br>depth to increment candidate plane values per iteration to satisfy selection.
sparseshadowtree_plane_incr_per_step_viewmodel | cl | Default: 0.0025<br>(viewmodel) depth to increment candidate plane values per iteration to satisfy selection.
sparseshadowtree_plane_max_error | cl | Default: 4e-05<br>max error (distance away in depth) candidate plane is allowed before rejecting.
sparseshadowtree_plane_max_error_viewmodel | cl | Default: 0.01<br>(viewmodel) max error (distance away in depth) candidate plane is allowed before rejecting.
sparseshadowtree_plane_num_iter | cl | Default: 5<br>number of steps to push candidate plane behind depths.
sparseshadowtree_render_cables | cl | Default: false<br>Render cables into SST.
sparseshadowtree_renderdoc_capture_generation | cl | Default: false<br>Capture dual shadow maps during sparseshadowtree generation.
sparseshadowtree_unpack_direct_to_shadow_atlas | cl | Default: false<br>unpack SST directly into shadow atlas cascade vs via staging texture PS copy (NOTE - rendersystem fix reqd for AMD + driver fix required for NV + VK only.
sparseshadowtree_uv_frac_offset_x | cl | Default: 0<br>uv x offset during copy to cascade.
sparseshadowtree_uv_frac_offset_y | cl | Default: 0<br>uv y offset during copy to cascade.
sparseshadowtree_viewmodel_uses_cascade0 | cl | Default: false<br>Re-use cascade 0 SST for viewmodel to save on the significant extra memory. Flipping this invalidates generated SSTs if viewmodel SST not already generated.
...
sv_air_pushaway_dist | sv, cl, rep, release | Default: 0<br>
...
sv_debug_player_use | sv, cl, rep | Default: false<br>Visualizes +use logic. Green cross=trace success, Red cross=trace too far, Green box=radius success
...
sv_guardian_health_refresh_per_wave | sv, release | Default: 50<br>Health given to survivors per wave in guardian mode.
sv_guardian_heavy_all | sv, release | Default: false<br>
sv_guardian_heavy_count | sv, release | Default: 0<br>
...
sv_guardian_starting_equipment_humans | sv, release | Default: <br>Extra starting equipment for human players in guardian modes
...
ui_inspect_bkgnd_map_B0B70CFF | cl, a, release | Default: warehouse<br>Inspect background map
...
ui_mainmenu_bkgnd_movie_B0B70CFF | cl, a, release | Default: ar_baggage<br>Main menu background movie
...
vm_camera | cl | Default: true<br>
vm_camera_interp_speed | cl | Default: 8<br>
vm_camera_no_roll | cl | Default: false<br>
vm_camera_scale | cl | Default: 1<br>
vm_debug | sv, cl, rep | Default: 0<br>
vm_draw_always | cl | Default: false<br>
...
vphysics_force_apply_magnitude |  | Default: 1<br>
vphysics_return_implicit_velocity |  | Default: false<br>
